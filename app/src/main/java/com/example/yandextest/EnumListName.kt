...
enum class EnumListName(val value: String) {
    ...
    WEB_SOCKET("wss://ws.finnhub.io?token=" + KEY_FINNHUB),
    QUOTE("https://mboum.com/api/v1/qu/quote/?symbol=<MY_SYMBOL>&apikey=" + KEY_MBOUM.value),
    SEARCH("https://www.alphavantage.co/query?function=SYMBOL_SEARCH&keywords=<MY_SYMBOL>&apikey=" + KEY_ALPHAVANTAGE),
    ...
    NEWS_SENTIMENTS("https://finnhub.io/api/v1/news-sentiment?symbol=<MY_SYMBOL>&token=" + KEY_FINNHUB),
